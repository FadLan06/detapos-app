...
class Kasir extends CI_Controller
{
    ...
    function data_kasir()
    {
        ...
        $data = $this->db->query("SELECT *, sum(harga * qty - potongan) as sub_total, sum(modal * qty) as hg_pokok, sum(qty) as kty FROM tb_detail_penjualan_tmp WHERE token='$token' AND petugas='$petugas' GROUP BY kode_barang ORDER BY kode_barang")->result();
        echo json_encode($data);
    }
