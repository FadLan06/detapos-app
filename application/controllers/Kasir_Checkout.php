...
class Kasir_Checkout extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('transaksi/kasir_checkout', $data);
    ...
    public function smpn_pen()
    {
        if (isset($_POST['enter'])) {
            ...
            if ($dt->num_rows() > 0) {
                ...
                redirect('Kasir_Checkout/Cetak_Struk/' . $no_transaksi);
            }
        }
    }
    ...
    public function cetak_struk($id)
    {
        ...
        if (($akses3['menu_id'] = 40) && ($akses2['menu_id'] = 39)) {
