                        ...
                        <form method="post" action="<?= base_url('Barang/Aksi') ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" name="warna" id="warna" class="form-control" autocomplete="off">
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="ukuran">UKURAN</label>
                                    <input type="text" name="ukuran" id="ukuran" class="form-control" autocomplete="off">
                                </div>
                                <div class="form-group col-md-2">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control ckeditor border-deta" name="deskripsi" id="inputZip" required></textarea>
                                </div>
                            </div>
                            <hr class="bg-deta">
                            <button type="submit" class="btn btn-deta float-right" name="smpn_brng_el">Tambah</button>
                ...
                <form action="" class="formSerial" method="post">
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control border-deta" id="inputSerial" name="serial_num" autocomplete="off" required>
                        </div>
                        <div class="form-group col-md-4">
