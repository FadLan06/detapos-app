                            ...
                            <form action="" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="<?= site_url('Profit/Tambah') ?>" class="btn btn-danger btn-sm mr-1"><i class="fas fa-plus-circle"></i> Tambah</a>
                                    </div>
                                </div>
                            </form>
...
<script>
    $(document).ready(function() {
        $('#cari').click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?= base_url('Profit/viewProfit') ?>",
                data: {
                    filter: filter,
                    tanggal: tanggal,
                    bulan: bulan,
                ...
                beforeSend: function() {
                    document.getElementById("viewProfit").innerHTML = "<tr><td colspan='4'><div class='spinner-border spinner-border-sm' role='status'><span class='sr-only'>Loading...</span></div> Memuat data...</td></tr>";
                },
                success: function(hasil) {
                    $('#viewProfit').html(hasil);
                }
            });
            return false;
        });
    ...
    $(document).ready(function() {
        $('#cari').click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: "<?= base_url('Profit/viewFilter') ?>",
                data: {
                    filter: filter,
                    tanggal: tanggal,
                    bulan: bulan,
