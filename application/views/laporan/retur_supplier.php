          ...
          <div class="card-body">
            <div class="input-group">
              ...
              <?php if (isset($_POST['cari'])) { ?>
                <form action="<?= base_url('Laporan/Export_Rt_Sup') ?>" method="post">
              ...
              <?php } ?>
              <?php if (isset($_POST['cari'])) { ?>
                <form action="<?= base_url('Supplier/Cetak_Supplier') ?>" method="post" target="_blank">
                  <input type="hidden" name="filter" id="filter" class="form-control" value="<?= $_POST['filter'] ?>">
                  <input type="hidden" name="tanggal" id="tanggal" class="form-control" value="<?= $_POST['tanggal'] ?>">
                  <input type="hidden" name="bulan" id="bulan" class="form-control" value="<?= $_POST['bulan'] ?>">
                  <input type="hidden" name="tahun" id="tahun" class="form-control" value="<?= $_POST['tahun'] ?>">
                  <a href="<?= base_url('Laporan/Retur_Supplier') ?>" class="btn btn-warning btn-sm"><i class="fas fa-sync-alt"></i> Refresh</a>
                    ...
                    <tbody>
                      ...
                      <?php foreach ($supp->result_array() as $sup) : ?>
                        ...
                        <tr align="center">
                          ...
                          <td><?= $sup['kode_supplier'] != null ? $supp['nama_toko'] : '' ?></td>
