<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card m-b-30">
                        ...
                        <form method="post">
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="kode_barang" id="kode2" onkeyup="isi_otomatisc()" placeholder="Kode Barang" autocomplete="off" autofocus required>
                                </div>
                    ...
                    <div class="card-footer" style="background-color: #fff; border-top: 2px solid #00aaff">
                        <form action="<?= base_url('Kasir_Checkout/smpn_pen') ?>" method="post">
                            <div class="form-row">
            ...
            <div class="col-sm-12">
                <p class="">Nama Kasir = <b><?= $user['nama'] ?></b></p>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#kode2').autocomplete({
            source: "<?php echo site_url('Kasir_Checkout/Auto_kasir'); ?>",
    ...
    $(document).ready(function() {
        ...
        $('#pelanggan2').autocomplete({
            source: "<?php echo site_url('Kasir_Checkout/Auto_pel'); ?>",
    ...
    function isi_otomatisc() {
        var kode = $("#kode2").val();
        $.ajax({
            url: '<?= site_url() . 'Kasir_Checkout/Proses' ?>',
            data: {
                kode: kode
            },
    ...
    function tampil_data_barang2() {
        $.ajax({
            type: 'GET',
            url: '<?php echo base_url() ?>Kasir_Checkout/data_kasir',
            async: true,
            dataType: 'json',
            success: function(data) {
                var html = '';
    ...
    $('#btn_simpan2').on('click', function() {
        ...
        if (valid) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('Kasir_Checkout/simpan_barang') ?>",
                dataType: "JSON",
                data: {
                    kobar: kobar,
                    nabar: nabar,
    ...
    $(document).on('click', '.hpus', function() {
        ...
        var hg = $(this).attr("hg");
        $.ajax({
            url: "<?php echo base_url(); ?>Kasir_Checkout/delete",
            method: "POST",
            data: {
                id: id,
                hg: hg
...
<script type="text/javascript">
    $(document).on('keyup', '#qty2', function() {
        ...
        if (qty) {
            $.ajax({
                url: "<?= base_url('Kasir_Checkout/cek_barang') ?>",
                type: 'POST',
                data: {
                    kode: kode,
                    qty: qty
    ...
    $(document).on('blur', '#kode2', function() {
        ...
        if (kode != "") {
            $.ajax({
                url: "<?= base_url('Kasir_Checkout/Ambil_data') ?>",
                type: 'POST',
                data: {
                    kode: kode
                },
