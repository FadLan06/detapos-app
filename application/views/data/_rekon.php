<form method="POST" action="<?= base_url('Data_rekon/Aksi') ?>">
    <input type="hidden" value="<?= $data->id_rekon_tmp ?>" name="id_rekon">
    <input type="hidden" value="<?= $data->saldo ?>" name="saldo">
    <div class="form-group">
        <label for="inputAddress">Tanggal Transaksi</label>
        <input type="date" class="form-control" name="tgl_rekon" id="inputAddress" placeholder="1234 Main St" value="<?= $data->tgl_rekon_tmp ?>" readonly required>
    </div>
    <div class="form-group">
